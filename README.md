...
Цей проєкт демонструє використання **React Context** у багаторівневій архітектурі компонентів. Дані користувачів завантажуються з API через `useEffect` та `axios`. Реалізовано глобальний контекст із темою, мовою та обраним користувачем. Обраний користувач зберігається у контексті та відображається у профілі. Також реалізовано обробку станів завантаження та помилки.
...
```bash
git clone https://github.com/BieliaievaIryna/fullstack-hw44-react-context
```
...
Розгорнуто на [Vercel](https://fullstack-hw44-react-context.vercel.app/)
